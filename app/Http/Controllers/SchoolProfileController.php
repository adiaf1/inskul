...
class SchoolProfileController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'teacher_check_in_time' => ['required', 'date_format:H:i'],
            'teacher_late_tolerance_minutes' => ['required', 'integer', 'min:0', 'max:240'],
            'teacher_check_out_time' => ['required', 'date_format:H:i'],
            'teacher_early_leave_tolerance_minutes' => ['required', 'integer', 'min:0', 'max:240'],
            'teacher_attendance_latitude' => ['nullable', 'numeric', 'between:-90,90'],
            'teacher_attendance_longitude' => ['nullable', 'numeric', 'between:-180,180'],
            'teacher_attendance_radius_meters' => ['required', 'integer', 'min:1', 'max:5000'],
            'teacher_attendance_max_accuracy_meters' => ['required', 'integer', 'min:1', 'max:5000'],
        ...
        $school->update([
            ...
            'principal_nip' => $validated['principal_nip'] ?? null,
            ...
            'teacher_check_in_time' => $validated['teacher_check_in_time'],
            'teacher_late_tolerance_minutes' => $validated['teacher_late_tolerance_minutes'],
            'teacher_check_out_time' => $validated['teacher_check_out_time'],
            'teacher_early_leave_tolerance_minutes' => $validated['teacher_early_leave_tolerance_minutes'],
            'teacher_attendance_latitude' => $validated['teacher_attendance_latitude'] ?? null,
            'teacher_attendance_longitude' => $validated['teacher_attendance_longitude'] ?? null,
            'teacher_attendance_radius_meters' => $validated['teacher_attendance_radius_meters'],
            'teacher_attendance_max_accuracy_meters' => $validated['teacher_attendance_max_accuracy_meters'],
            'logo_path' => $logoPath,
