...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 py-4 mb-2">
        <div>
            <h4 class="mb-1">Jadwal Pelajaran</h4>
            <p class="text-muted mb-0">{{ $school->name }} - jadwal yang terdaftar untuk {{ $student->user?->name }}.</p>
        </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('student-schedules.index') }}">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-5">
                        ...
                        <select class="form-select" id="classroom_id" name="classroom_id">
                            <option value="">Semua Rombel Aktif</option>
                    ...
                    <div class="col-md-3">
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('student-schedules.index') }}" class="btn btn-label-secondary">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center text-muted py-5">
                                    Belum ada jadwal pelajaran yang terdaftar untuk rombel aktif Anda.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
